...
public class TextngListners 
{
	...
	public void CreateReport()
	{
		...
		ExtentSparkReporter extentSparkReporter=new ExtentSparkReporter("./reports/passReport.html");
		extentReport.attachReporter(extentSparkReporter);
		ExtentSparkReporter extentSparkReporter2=new ExtentSparkReporter("./reports/failReport.html");
	...
	public void CheckLoginWithValidData()throws InterruptedException 
	{
		...
		public void OpencartQuickSearch() throws IOException
		{
			...
			try {
				...
				driver2.findElement(By.id("adadas")).sendKeys("HELLO");
				extentTest2.log(Status.PASS,"------");
			}
	catch(NoSuchElementException e)
			{
		extentTest2.log(Status.FAIL,"Above element cannot be located");
			}

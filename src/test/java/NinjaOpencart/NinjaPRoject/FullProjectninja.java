...
public class FullProjectninja {
	...
	Thread.sleep(2000);
	driver.findElement(By.id("input-email")).sendKeys(myEmail1);    //registration
	driver.findElement(By.id("input-telephone")).sendKeys(myTelephone);
	Thread.sleep(2000);
	driver.findElement(By.id("input-password")).sendKeys(myPassword1);
	driver.findElement(By.id("input-confirm")).sendKeys(myConfirm);
